...
# Initialize memory with a buffer of 5 interactions
memory = ConversationBufferWindowMemory(k=5)

# Load the text file
try:
    loader = TextLoader("inheritance.txt")
...
while True:
    human_message = input("Ask about Islamic Law of Inheritance (or type 'exit' to quit): ")
